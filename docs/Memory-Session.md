...
import (
    "time"
    "github.com/ink-code/gint/session"
    "github.com/ink-code/gint/session/memory"
    "github.com/ink-code/gint/session/header"
)
...
```go
import "github.com/ink-code/gint/session/cookie"
...
```go
// 开发环境
import "github.com/ink-code/gint/session/memory"
provider := memory.NewProvider(jwtKey, expiration, carrier)

// 生产环境
import (
    "github.com/redis/go-redis/v9"
    redisSession "github.com/ink-code/gint/session/redis"
)
